    ...
    <div class="col-lg-4 col-md-3">
        <div class="mt-3">
            ...
            <div class="modal-dialog">
                <form class="modal-content" wire:submit.prevent="">
                <div class="modal-header">
                    <h5 class="modal-title" id="backDropModalTitle">Account Deletion</h5>
                    <button
                    type="button"
                    class="btn-close"
                ...
                <div class="modal-body">
                    <div class="row">
                    <div class="col mb-0">
                        <p class="text-center text-warning"><i>Press OK button to complete the operation</i></p>
                    </div>
                    </div>
