...
<html
  ...
  <body>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Zechamus</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <a href="{{ route('home') }} " class="menu-link">
                ...
                <div data-i18n="Analytics">Switch Frontend</div>
            </a>
            </li>

            <!-- User Management -->
            <li class="menu-item {{request()->segment(1) == 'user-management' ? 'active': ''}}  ">
            ...
            <li class="menu-item {{request()->segment(1) == 'account-setting' ? 'active open': ''}}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bxs-cog"></i>
                <div data-i18n="Account Settings">Account Settings</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item {{request()->segment(1) == 'account-setting' ? 'active': ''}} ">
            ...
            <li class="menu-item {{request()->segment(1) == 'catalogue-setting' ? 'active open': ''}}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">Catalogue</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item {{request()->segment(1) == 'catalogue-setting' ? 'active': ''}}">
                  <a href="{{ route('catalogue-setting') }} " class="menu-link">
    ...
    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
      ...
      @livewire('backend.dashboard-navbar')
  ...
  <!-- / Navbar -->
    ...
    <script defer src="{{ asset('assets/backend/vendor/libs/popper/popper.js') }} "></script>
    <script defer src="{{ asset('assets/backend/vendor/js/bootstrap.js') }} "></script>
    <script defer src="{{ asset('assets/backend/vendor/libs/perfect-scrollbar/perfect-scrollbar.js') }} "></script>
