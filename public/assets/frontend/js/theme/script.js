...
(function ($) {
  ...
  //show more and less for welcome page
  $('#show_more_btn').on('click', function(){
    const currentClassName = document.getElementById('show_more').className;
    if(currentClassName=="d-none"){
      $('#show_more_btn').removeClass('d-block');
      $('#show_more_btn').addClass('d-none');
      $('#show_more').removeClass('d-none');
      $('#show_more').addClass('d-block');
    }
  });

  $('#show_less_btn').on('click', function(){
    const currentClassName = document.getElementById('show_more').className;
    if(currentClassName=="d-block"){
      $('#show_more_btn').removeClass('d-none')
      $('#show_more_btn').addClass('d-block');
      $('#show_more').removeClass('d-block');
